...
logdir = Path("~/logdir/dreamer/POL_multigoal9/size12m/06").expanduser()
outdir = Path("plots") / f"single_run_POL_multigoal9_size12m_06"
...
ax.set_title("POL_multigoal9 / size12m / 06")
