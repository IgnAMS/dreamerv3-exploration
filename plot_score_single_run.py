...
logdir = Path("~/logdir/dreamer/POL_multigoalfixed10/size12m/02").expanduser()
outdir = Path("plots") / f"single_run_POL_multigoalfixed10_size12m_02"
...
ax.set_title("POL_multigoalfixed10 / size12m / 02")
