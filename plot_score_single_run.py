...
logdir = Path("~/logdir/dreamer/POL_HER_hergoal9/size12m/02").expanduser()
outdir = Path("plots") / f"single_run_POL_HER_hergoal9_size12m_02"
...
ax.set_title("POL_HER_hergoal9 / size12m / 02")
