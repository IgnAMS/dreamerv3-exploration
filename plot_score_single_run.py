...
logdir = Path("~/logdir/dreamer/HER_POL_hergoal9_k8/size12m/03").expanduser()
outdir = Path("plots") / f"single_run_HER_POL_hergoal9_k8_size12m_03"
...
ax.set_title("HER_OBS_hergoal9 k=8 RELABEL / size12m / 03")
