...
The intrinsic reward is calculated by the norm of the predictor and target network. Then the reward is normalized by dividing it by the standard deviation.
