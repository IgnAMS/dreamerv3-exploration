# Code from: https://github.com/wisnunugroho21/reinforcement_learning_ppo_rnd/blob/master/PPO_RND/pytorch/ppo_rnd_pytorch.py :)
...
class Agent():  
    def __init__(self, state_dim, action_dim, is_training_mode, policy_kl_range, policy_params, value_clip, entropy_coef, vf_loss_coef,
        ...
        self.rnd_target             = RND_Model(self.encoder_rnd_target, action_dim)
        self.rnd_predict_optimizer  = Adam(self.rnd_predict.parameters(), lr = learning_rate)

        # Congelamos la target!
